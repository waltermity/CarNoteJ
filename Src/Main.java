...
public class Main {
   ...
   * @throws IOException A paraméterként megkapott lista tartalmát írja ki .xml fájlba egy külső
   *     könyvtár segítségével. A használt könyvtár "XStream", az írás sikerességéről az elkapott
   *     IOExcep. alapján tudunk vélekedni. FileWriterrel kiírjuk az XStream által generált
   *     objektumot.
   */
  public static void printData(ArrayList<Jarmu> list) throws IOException {
  ...
  /**
   * @return Lista, a beolvasott fájl tartalmával Xml fájlból, külső (Xstream) könyvtár segítségével
  ...
  public static ArrayList<Jarmu> readData() {
    try {
      ...
      TypePermission wildcardTypePermission =
          new WildcardTypePermission(
              new String[] {
                "----PATH_TO----\\CarNoteJ\\CarNoteJ\\src"
              }); // Replace with the package name of your Jarmu class
  ...
  public static void main(String[] args) {
    ...
    // A program bezáródása előtt kiírja fájlba az adatokat, a lambdás kifejezés miatt kell egy
    // "final" változó(amit nem változtatunk már)
